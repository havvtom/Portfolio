<template>
  <div class="p-0" :class="{'pl-4': $vuetify.breakpoint.smAndDown}" color="success">
    <p id="first">
      Hi, my name is 
    </p>
    <p class="display-3 font-weight-bold" id="second">
      Tom Havatyi.
    </p>
    <p id="third" class="display-3 font-weight-bold">
